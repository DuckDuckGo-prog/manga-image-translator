...
class GroqTranslator(CommonTranslator):
    ...
    'For idiomatic expressions, onomatopoeia, or sound effects, maintain the original and context. '
    "If any ambiguity arises due to insufficient context, default to a neutral ambiguous translation and don't just assume genders. "
